...
import { TrafficBar, TrafficBarData } from "@remlore/core/data/traffic-bar";
import { TrafficList, TrafficListData } from "@remlore/core/data/traffic-list";
...
@Component({
  selector: "rl-traffic-reveal-card",
